...
/***/ function(module, exports, __webpack_require__) {
	...
	var _messageManager = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var proto = function proto(options) {
	    ...
	    for (var i = 0; i < this.initializors.length; i++) {
	        this.initializors[i].call(this, options);
	    }
	};
	...
	_underscore2['default'].extend(proto.prototype, {
	    ...
	    _useModule: function _useModule(mod) {
	        _underscore2['default'].extend(this, _underscore2['default'].omit(mod, ['events', 'initialize']));
	...
	_underscore2['default'].extend(BaseView.modules, _modules2['default']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateAutoRender = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	     ...
	     * @private
	     */
	    _onAjaxSend: function _onAjaxSend() {
	     ...
	     * @private
	     */
	    _onAjaxComplete: function _onAjaxComplete() {
	        var $loading = this._$loading;
	    ...
	    initialize: function initialize() {
	        ...
	        (0, _jquery2['default'])(document).on('ajaxSend', this._onAjaxSend).on('ajaxComplete', this._onAjaxComplete);
	    },
	    /**
	    ...
	    remove: function remove() {
	        ...
	        (0, _jquery2['default'])(document).off('ajaxSend', this._onAjaxSend).off('ajaxComplete', this._onAjaxComplete);
	        this._$loading = null;
	    }
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	    ...
	    preload: function preload() {
	        ...
	        var promises = _variables.slice.call(this.$('[data-preload]')).map(function (item) {
	            ...
	            return Promise.resolve(_jquery2['default'].postJSON(uri)).then(function (data) {
	                ...
	                _this.renderSelect($item, result, displayField, valueField);
	     ...
	     */
	    renderSelect: function renderSelect($select, options, displayField, valueField) {
	        if (options == null) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	    ...
	    pageSizeUpdate: function pageSizeUpdate(e) {
	        ...
	        var pageSize = parseInt($target.val(), 10);
	        if (isNaN(pageSize)) {
	            pageSize = 10;
	        }
	    ...
	    orderUpdate: function orderUpdate(e) {
	        ...
	        var orderStr = (0, _jquery2['default'])(e.target).attr('order-field').trim();
	        if (orderStr === '') {
	            return;
	        }
	    ...
	    selectAll: function selectAll(e) {
	        ...
	        _variables.slice.call(this.$('.item-select')).forEach(function (item) {
	    ...
	    setOrderMark: function setOrderMark() {
	        ...
	        this.$('.order-mark').remove().appendTo(this.$('[order-field^=' + curOrder[0] + ']')).removeClass('icons-12-up icons-12-down').addClass(curOrder[1] === 'ASC' ? 'icons-12-up' : 'icons-12-down');
	    }
	};
	module.exports = exports['default'];
	...
	exports['default'] = {
	    ...
	    initialize: function initialize() {
	        ...
	        _variablesSlice2['default'].call($tpls).forEach(function (item) {
	            ...
	            $item.parent().attr('data-template', id);
	        }, this);
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jquery85ido = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
		...
		for (var key in obj) {
			if (obj.hasOwnProperty(key)) {
				...
				switch (typeof val) {
					case "string":
						if (val.match(/^\/Date\(([\-\d]+)\)\/$/)) {
							obj[key] = new Date(parseInt(RegExp.$1, 10));
						}
						break;
					case "object":
						_fixJsonDate(val);
	...
	var postJSON = function postJSON(url, params, options) {
		...
		return _jquery2["default"].ajax(url, opt);
	};
